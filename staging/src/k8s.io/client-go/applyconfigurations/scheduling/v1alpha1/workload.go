...
type WorkloadApplyConfiguration struct {
	...
	*v1.ObjectMetaApplyConfiguration `json:"metadata,omitempty"`
	...
	Status                           *schedulingv1alpha1.WorkloadStatus `json:"status,omitempty"`
}
...
// ExtractWorkloadStatus extracts the applied configuration owned by fieldManager from
// workload for the status subresource.
func ExtractWorkloadStatus(workload *schedulingv1alpha1.Workload, fieldManager string) (*WorkloadApplyConfiguration, error) {
	return ExtractWorkloadFrom(workload, fieldManager, "status")
}
...
func (b *WorkloadApplyConfiguration) WithStatus(value schedulingv1alpha1.WorkloadStatus) *WorkloadApplyConfiguration {
	b.Status = &value
	return b
}
