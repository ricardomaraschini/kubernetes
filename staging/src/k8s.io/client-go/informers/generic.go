...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	...
	case schedulingv1alpha2.SchemeGroupVersion.WithResource("placementrequests"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Scheduling().V1alpha2().PlacementRequests().Informer()}, nil
